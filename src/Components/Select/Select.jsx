...
export default function Select() {
    ...
    return (
        <>
            <Container>
                <div className={s.select__path}><a onClick={() => nav('/')} className={s.select__mainLink}>Главная</a> <svg className={s.select__arrow} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
